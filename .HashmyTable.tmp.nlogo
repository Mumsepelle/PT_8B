globals[hashTable]
extensions[table]
turtles-own[anger fear willToDemonstrate]
...
to setup
  ...
  [
    ...
    addToHashTable (word who) "numToDemonstrate" (word (random 2))

    addToHashTable (word who) "willToDemonstrate" (word (fear + anger))
  ]
...
;============================TERMINAL COMMANDS====================================
;ask turtle 0 [changeToDemonstrate "1"]
;ask turtle 0 [getTotal "numToDemonstrate"]
